...
export default function SignupPage() {
  ...
  const strengthColors = ["", "var(--accent-red)", "var(--accent-yellow)", "var(--accent-green)"];
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background: "radial-gradient(ellipse at 50% 40%, rgba(136,85,255,0.08) 0%, transparent 60%)",
        }}
      />
      ...
      <div className="w-full max-w-md relative">
        <div className="text-center mb-8">
          ...
          <p style={{ color: "var(--text-secondary)" }}>
            Start producing better podcasts today
          </p>
        </div>
          ...
          <div className="mt-6 pt-6 border-t" style={{ borderColor: "var(--border)" }}>
            <div className="space-y-2">
              {[
                ...
                "All 4 AI crew members included",
                "3 sessions per month on free plan",
              ].map((item) => (
