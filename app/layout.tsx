...
export const metadata: Metadata = {
  title: "Podcast Crew - AI Production Assistant",
  description:
    "Real-time AI production assistant for podcasters. Fact-check, get context, comedy, and news in real-time.",
  keywords: ["podcast", "AI", "production", "transcription", "real-time"],
};
